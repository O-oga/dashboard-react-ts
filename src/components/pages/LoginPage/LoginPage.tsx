  ...
  const highlightHomeAssistant = (text: string) => {
    ...
    return parts.map((part, index) =>
      /Home Assistant/i.test(part) ? (
        <span key={index} className="home-assistant-highlight">
          {part}
        </span>
      ) : (
        part
    ...
    <div className="login-page">
      <div className="login-container">
        <h1 className="login-title">
          {highlightHomeAssistant(t('login.title'))}
        </h1>
        ...
        <div className="login-form">
          ...
          <div className="button-container">
            {isConnected && (
              <div
                className={`ping-indicator ${pingLatency !== null ? 'ping-indicator-visible' : 'ping-indicator-loading'}`}
              >
                {pingLatency !== null
