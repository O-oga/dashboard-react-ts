...
function NaviPanelAddCard(props: any) {
    ...
    return (
        <button
            ...
            onClick={onOpenModal}
        >
            <svg className="card-svg" viewBox="0 0 24 24" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <path d="M10 14H12M12 14H14M12 14V16M12 14V12" strokeWidth="1.5" strokeLinecap="round" />
...
export default NaviPanelAddCard;